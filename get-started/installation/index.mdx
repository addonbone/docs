...
:::tip
Replace placeholder links (e.g., entry files directory, examples directory) with actual URLs or paths in your Docusaurus project.
:::
...
Start developing your Addon Bone extension after setup.
...
(manual setup for now; automation planned.) Load in Chrome:
...
Use the --target flag in the form of `<browser-name>-<manifest-version>`.
